...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            Product cheese = new Product("Cheese", 100, 5, true, 0.4, true, LocalDate.of(2025, 8, 1));
            Product biscuits = new Product("Biscuits", 150, 3, true, 0.7, true, LocalDate.of(2025, 7, 10));
            Product tv = new Product("TV", 300, 2, true, 10.0, false, null);
            Product scratchCard = new Product("Scratch Card", 50, 10, false, 0.0, false, null);
        ...
        try {
            Product expiredCheese = new Product("Expired Cheese", 100, 2, true, 0.5, true, LocalDate.of(2023, 1, 1));
        ...
        System.out.println("\n--- 5. Out of Stock Case ---");
        try {
            Product tv = new Product("TV", 300, 1, true, 10.0, false, null);
